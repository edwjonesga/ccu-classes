# CSC-240 Assignment Setup

Welcome to CSC-240! This guide will walk you through setting up your development environment using a two-stage Docker process.
...
[Download the Dockerfile here](https://raw.githubusercontent.com/edwjonesga/ccu-classes/main/csc-240/Dockerfile)
...
4.  Run the initializer container, mounting your current directory into the container's `/workspace`:
    ...
    - **For Windows (using Command Prompt):**
      ```sh
      docker run -it --rm -v "%cd%":/workspace csc-240-init-env
      ```
